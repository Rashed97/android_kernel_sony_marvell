...
wlan_init_adapter(pmlan_adapter pmadapter)
{
    ...
    pmadapter->usb_tx_aggr.aggr_ctrl.enable = MFALSE;
    pmadapter->usb_tx_aggr.aggr_ctrl.aggr_mode = MLAN_USB_AGGR_MODE_NUM;
    pmadapter->usb_tx_aggr.aggr_ctrl.aggr_align =
        MAX(pmadapter->max_tx_buf_size, MLAN_USB_TX_AGGR_ALIGN);
    pmadapter->usb_tx_aggr.aggr_ctrl.aggr_max = MLAN_USB_TX_MAX_AGGR_NUM;
    pmadapter->usb_tx_aggr.aggr_ctrl.aggr_tmo =
        MLAN_USB_TX_AGGR_TIMEOUT_MSEC * 1000;

    pmadapter->usb_tx_aggr.pmbuf_aggr = MNULL;
    pmadapter->usb_tx_aggr.hold_timeout_msec = MLAN_USB_TX_AGGR_TIMEOUT_MSEC;
...
wlan_free_lock_list(IN pmlan_adapter pmadapter)
{
    ...
    if (pmadapter->usb_tx_aggr.paggr_lock)
        pcb->moal_free_lock(pmadapter->pmoal_handle,
                            pmadapter->usb_tx_aggr.paggr_lock);
...
wlan_init_timer(IN pmlan_adapter pmadapter)
{
    ...
    if (pcb->
        moal_init_timer(pmadapter->pmoal_handle,
                        &pmadapter->usb_tx_aggr.paggr_hold_timer,
                        wlan_usb_tx_aggr_timeout_func, pmadapter)
        != MLAN_STATUS_SUCCESS) {
        ret = MLAN_STATUS_FAILURE;
        goto error;
    }
...
wlan_free_timer(IN pmlan_adapter pmadapter)
{
    ...
    if (pmadapter->usb_tx_aggr.paggr_hold_timer)
        pcb->moal_free_timer(pmadapter->pmoal_handle,
                             pmadapter->usb_tx_aggr.paggr_hold_timer);
...
wlan_free_adapter(pmlan_adapter pmadapter)
{
    ...
    if (pmadapter->usb_tx_aggr.aggr_hold_timer_is_set) {
