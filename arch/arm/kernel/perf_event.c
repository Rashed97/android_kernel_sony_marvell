...
static const char *arm_pmu_names[] = {
	...
	[ARM_PERF_PMU_ID_PJ4B]  = "Marvell PJ4B",
};
...
static inline int armv7_pj4b_pmu_event_map(int config)
{
	int mapping = armv7_pj4b_perf_map[config];
	if (HW_OP_UNSUPPORTED == mapping)
		mapping = -EOPNOTSUPP;
	return mapping;
}
...
init_hw_perf_events(void)
{
	...
	/* Marvell CPUs */
		...
		case 0x5840:
			...
			memcpy(armpmu_perf_cache_map, armv7_pj4b_perf_cache_map,
				sizeof(armv7_pj4b_perf_cache_map));
			armv7pmu.event_map = armv7_pj4b_pmu_event_map;
			armpmu = &armv7pmu;
